...
const EditNoticia = (noticiaselect) => {
  ...
  function CrearNoticia() {
    ...
    const noticia = {
      id: noticiaselect.id,
      titulo: noticiaselect.titulo,
      descripcion: noticiaselect.descripcion,
      idUser: noticiaselect.id_user,
      visible: noticiaselect.visible,
      fechaCreacion: noticiaselect.fecha_creacion,
      categoria: noticiaselect.categoria,
      horaNoticia: noticiaselect.hora_noticia,
      imagen: noticiaselect.imagen,
      resumen: noticiaselect.resumen
    };
